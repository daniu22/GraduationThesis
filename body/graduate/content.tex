...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.\linewidth]{contact_prob.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.\linewidth]{rectangle_track.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.4\linewidth]{正视图.png}
    \caption{\label{fig:centroid}WuKong-IV双足机器人实物样机}
\end{figure}
本文研究基于双足机器人WuKong-IV实验平台实现，实物图见图2.1，WuKong-IV双
足机器人是浙江大学研发的双足仿人机器人移动实验平台。机器人身高约1.3m，重约
48kg，其中大腿连杆长度为0.3m，小腿连杆长度0.285m。全身共有21个自由度，其中
